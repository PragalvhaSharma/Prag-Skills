#!/usr/bin/env bash
# Link the canonical slides skill into Claude Code, Codex, and Cursor.
# Canonical: ~/.claude/skills/slides
# Usage: bash ~/.claude/skills/slides/sync.sh

set -euo pipefail

CANON="${HOME}/.claude/skills/slides"
TARGETS=(
  "${HOME}/.codex/skills/slides"
  "${HOME}/.cursor/skills/slides"
)
